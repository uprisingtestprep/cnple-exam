/* CNPLE Exam Simulator, Application Logic */

const ACCESS_CODE  = "CNPLE9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "cnple_exam_state_v1";
const SIM_Q_COUNT  = 185;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"assessment": "Assessment", "diagnosis": "Diagnosis", "management": "Management", "counselling": "Counselling", "transition_of_care_and_documentation": "Transition of Care and Documentation", "quality_improvement_and_research": "Quality Improvement and Research", "leader": "Leader", "educator": "Educator", "advocate": "Advocate"};  // maps domain key -> human-readable label for display
...
// Shuffle by UNIT, never by individual question. A case cluster is 3 to 5
// questions sharing one clinical scenario, and they must stay together and in
// their authored order: questions later in a cluster refer back to the same
// client. Shuffling every question individually scattered all 16 clusters
// across the exam, which only showed up when the live site was driven with a
...
// Case-based questions (30-35% of the real CNPLE) share one clinical scenario
// across 3-5 linked questions. Show it above every question in the cluster so a
// candidate never has to page backwards to reread the case.
